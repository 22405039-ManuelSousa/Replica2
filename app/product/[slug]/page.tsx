...
export default function ProductPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 p-6 md:p-8 mix-blend-difference text-white">
                <button 
                    onClick={() => router.back()}
                    ...
                    <div className="space-y-6 pt-4">
                        <div className="flex items-center gap-6">
                            ...
                            <button
                                ...
                                className={`flex-1 py-4 px-8 rounded-full font-medium tracking-wide transition-all duration-300 flex items-center justify-center gap-2 ${
                                    isAdding 
